domdev_dist_chooseterms <- function ( size, population, reps, generations, epsilonrange1, epsilonrange2, avgeff, domdev, loud = TRUE, term1 = TRUE, term2 = TRUE, term3 = TRUE, term4 = TRUE, term5 = TRUE, term6 = TRUE ) {
...
hist( x, main = paste ( "domdev = ", -0.2, ", avgeff = ", 0.5, ", populations = ", 1, ", reps = ", 1000 ), breaks = 50 )
